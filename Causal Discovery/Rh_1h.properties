...
C1d1 = np.cov(C1,np.diff(X1)[0:1030])[0][1]
C1d2 = np.cov(C1,np.diff(X2)[0:1030])[0][1]
C2d1 = np.cov(C2,np.diff(X1)[0:1030])[0][1]
C2d2 = np.cov(C2,np.diff(X2)[0:1030])[0][1]
